...
namespace TodoApp.Shared.Models
{
    ...
    {
        [EqualityHash] public ImmutableArray<Todo> Todos { get; } = ImmutableArray<Todo>.Empty;

        [EqualityIgnore] public int RemainingTodos => ActiveTodos.Count();

        [EqualityIgnore] public IEnumerable<Todo> ActiveTodos => Todos.Where(t => !t.IsDone);

        [EqualityIgnore] public IEnumerable<Todo> InactiveTodos => Todos.Where(t => t.IsDone);
    }
}